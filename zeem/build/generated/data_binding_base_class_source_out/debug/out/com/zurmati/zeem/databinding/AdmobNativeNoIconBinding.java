...
public final class AdmobNativeNoIconBinding implements ViewBinding {
  @NonNull
  ...
  private AdmobNativeNoIconBinding(@NonNull NativeAdView rootView, @NonNull TextView ad,
      @NonNull TextView adBody, @NonNull Button adCallToAction, @NonNull TextView adHeadline,
      @NonNull MediaView adMedia, @NonNull LinearLayout bottom) {
  ...
  @NonNull
  public static AdmobNativeNoIconBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdmobNativeNoIconBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.admob_native_no_icon, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdmobNativeNoIconBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdmobNativeNoIconBinding((NativeAdView) rootView, ad, adBody, adCallToAction,
          adHeadline, adMedia, bottom);
    }
