...
public final class AdmobNativeSideMediaBinding implements ViewBinding {
  @NonNull
  ...
  private AdmobNativeSideMediaBinding(@NonNull NativeAdView rootView, @NonNull TextView ad,
  ...
  @NonNull
  public static AdmobNativeSideMediaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdmobNativeSideMediaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.admob_native_side_media, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdmobNativeSideMediaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdmobNativeSideMediaBinding((NativeAdView) rootView, ad, adAppIcon, adBody,
          adCallToAction, adHeadline, adMedia, top);
    }
