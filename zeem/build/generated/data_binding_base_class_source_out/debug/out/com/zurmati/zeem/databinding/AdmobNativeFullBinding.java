...
public final class AdmobNativeFullBinding implements ViewBinding {
  @NonNull
  ...
  private AdmobNativeFullBinding(@NonNull NativeAdView rootView, @NonNull TextView ad,
      ...
      @NonNull TextView adStore, @NonNull LinearLayout bottom, @NonNull LinearLayout top) {
  ...
  @NonNull
  public static AdmobNativeFullBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdmobNativeFullBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.admob_native_full, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdmobNativeFullBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdmobNativeFullBinding((NativeAdView) rootView, ad, adAdvertiser, adAppIcon,
          adBody, adCallToAction, adHeadline, adMedia, adPrice, adStars, adStore, bottom, top);
    }
